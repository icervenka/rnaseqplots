...
source(paste0(script_folder, "pca.R"), local = TRUE)
source(paste0(script_folder, "read.R"), local = TRUE)
source(paste0(script_folder, "transform.R"), local = TRUE)
source(paste0(script_folder, "venn.R"), local = TRUE)
source(paste0(script_folder, "volcano.R"), local = TRUE)